    ...
    return ThemeData(
      ...
      // main color
        ...
        cardTheme: CardTheme(
          ...
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(SizesManager.s20)),
        ),
      listTileTheme: const ListTileThemeData(tileColor:  ColorsManager.white
        ,),
        // text theme
        textTheme:  const TextTheme(
          ...
          headlineMedium:  TextStyle(fontWeight: FontWeight.bold,  color: ColorsManager.black),
          // subtitle in card & about dev
          titleMedium: TextStyle(color:  ColorsManager.primaryColorDark,fontWeight: FontWeight.bold),
          titleSmall:  TextStyle(color:  ColorsManager.black,fontWeight: FontWeight.bold , ),
          headlineSmall: TextStyle(color:  ColorsManager.black,fontWeight: FontWeight.bold , ),
        ),
        ...
        // elevated ButtonTheme
          ...
          textStyle: TextStylesManager.semiBoldStyle(color:ColorsManager.black ),
            primary: ColorsManager.primaryColor,
            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(SizesManager.s14))
          )
        ),
        ...
        inputDecorationTheme: InputDecorationTheme(
          ...
          enabledBorder:  const OutlineInputBorder(
            borderSide:BorderSide(color:ColorsManager.primaryColorDark , width:SizesManager.s1 ),
            borderRadius: BorderRadius.all(Radius.circular(SizesManager.s20))

          ),
          focusedBorder:  const OutlineInputBorder(
              borderSide:BorderSide(color:ColorsManager.secondaryColor , width:SizesManager.s1 ),
              borderRadius: BorderRadius.all(Radius.circular(SizesManager.s20))

          ),
          errorBorder: const OutlineInputBorder(
              borderSide:BorderSide(color:ColorsManager.red , width:SizesManager.s1 ),
              borderRadius: BorderRadius.all(Radius.circular(SizesManager.s14))

          ),
          focusedErrorBorder: const OutlineInputBorder(
              borderSide:BorderSide(color:ColorsManager.primaryColor , width:SizesManager.s1 ),
              borderRadius: BorderRadius.all(Radius.circular(SizesManager.s14))
   ...
   return ThemeData(
     ...
     toggleableActiveColor: ColorsManager.primaryColor,
      switchTheme: SwitchThemeData(
        thumbColor:  MaterialStateProperty.all( ColorsManager.primaryColor,),
      ) ,
...
listTileTheme: const ListTileThemeData(tileColor:  ColorsManager.black,),
     // text theme
     textTheme:  const TextTheme(
       // recipe name in cards
         titleLarge: TextStyle(fontWeight: FontWeight.bold,color: ColorsManager.white),
         // Restaurants name & recipe name in details screen
         headlineMedium:  TextStyle(fontWeight: FontWeight.bold,  color: ColorsManager.white),
         // subtitle in card & about dev
         titleMedium: TextStyle(color:  ColorsManager.primaryColorDark,fontWeight: FontWeight.bold , ),
       titleSmall:  TextStyle(color:  ColorsManager.white,fontWeight: FontWeight.bold , ),
       headlineSmall: TextStyle(color:  ColorsManager.white,fontWeight: FontWeight.bold , ),
     ),
     ...
     elevatedButtonTheme: ElevatedButtonThemeData(
         style: ElevatedButton.styleFrom(
             textStyle: TextStylesManager.semiBoldStyle(color:ColorsManager.white ),
             primary: ColorsManager.primaryColor,
             shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(SizesManager.s14))
         )
     ),
