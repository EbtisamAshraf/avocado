  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: false,
        title:
            Text('أفــوكـادو', style: Theme.of(context).textTheme.titleLarge),
      ...
      body:   Column(
        children: [
          ...
          Expanded(
              child: selectedCategoryIndex == 0 ?const RecipesHomeScreen() :  CategoryDetailScreen(indexOfCategory:selectedCategoryIndex ,)),
        ],
      ),
    );
