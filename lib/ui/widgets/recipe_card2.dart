...
class RecipeCard2 extends StatelessWidget {
 ...
 const  RecipeCard2({Key? key, required this.indexOfRecipeList, required this.list,this.onTap}) : super(key: key);
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children:  [
                  Text(list[indexOfRecipeList].title, style: Theme.of(context).textTheme.titleLarge),
                  Text(list[indexOfRecipeList].categoryTitle, style: Theme.of(context).textTheme.titleMedium),
                ],
              ),
            ),
             Padding(
